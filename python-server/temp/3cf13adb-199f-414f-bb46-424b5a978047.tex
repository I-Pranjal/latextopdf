...
\setlist[itemize]{left=0pt, labelsep=0.5em, itemsep=0.2em, topsep=0.2em}
...
\begin{itemize}
  ...
  \item Movie Recommendation System (\textbf{link:} \href{https://hritik211.pythonanywhere.com/movie_recommend/}{https://hritik211.pythonanywhere.com/movie_recommend/}): Created a content-based movie recommendation system with a 92\% accuracy rate using Python, NLP, Flask, and Pythonanywhere, resulting in a 60\% increase in user retention.
